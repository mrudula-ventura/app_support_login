 document.addEventListener('DOMContentLoaded', function () {
            ...
            // Button event listeners for toggling sections
            document.getElementById('bankButton').addEventListener('click', function () {
                document.getElementById('bankCards').classList.add('active');
                document.getElementById('nomineeCards').classList.remove('active');
                document.getElementById('segmentCards').classList.remove('active');
                document.getElementById('dematCards').classList.remove('active');
            });

            document.getElementById('nomineeButton').addEventListener('click', function () {
                document.getElementById('nomineeCards').classList.add('active');
                document.getElementById('bankCards').classList.remove('active');
                document.getElementById('segmentCards').classList.remove('active');
                document.getElementById('dematCards').classList.remove('active');
            });

            document.getElementById('segmentButton').addEventListener('click', function () {
                document.getElementById('segmentCards').classList.add('active');
                document.getElementById('bankCards').classList.remove('active');
                document.getElementById('nomineeCards').classList.remove('active');
                document.getElementById('dematCards').classList.remove('active');
            });

            document.getElementById('dematButton').addEventListener('click', function () {
                document.getElementById('dematCards').classList.add('active');
                document.getElementById('bankCards').classList.remove('active');
                document.getElementById('nomineeCards').classList.remove('active');
                document.getElementById('segmentCards').classList.remove('active');
            });
